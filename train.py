...
init_from = 'scratch_0' # 'scratch' or 'resume' or 'gpt2*'
# wandb logging
...
def get_batch2(split, step):
    ...
    bix = np.arange((step*batch_size), ((step+1)*batch_size)) % num_blocks
    ix = block_size*block_indices[bix]
    x_list = []
    y_list = []
...
if 'scratch' in init_from:
    ...
    for k in ['n_layer', 'n_head', 'n_embd', 'block_size', 'bias', 'vocab_size', 'log_activations']:
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num > 0:
                ...
                torch.save(checkpoint, os.path.join(out_dir, f'ckpt{iter_num // eval_interval}_{init_from}.pt'))
